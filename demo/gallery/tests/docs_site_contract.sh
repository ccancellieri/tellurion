...
require_text docs/index.html 'Tellurion v0.5.0 stable release is public.'
...
require_text docs/index.html 'Product evidence: public Tellurion v0.5.0 stable binaries and source'
require_text docs/index.html 'Release update: 2026-09-16'
