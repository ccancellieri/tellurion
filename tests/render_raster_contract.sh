...
require_text render.yaml 'dockerfilePath: ./demo/gallery/Dockerfile.raster'
...
require_text README.md '**Visual entry point:** <https://ccancellieri.github.io/tellurion/>'
